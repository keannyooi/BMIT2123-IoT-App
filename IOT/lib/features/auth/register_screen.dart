...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    if (err != null) {
      ...
      // Registering already signs the user in via Firebase Auth, so pop back
      // to the app root (which watches AuthProvider) instead of pushing the
      // login screen - it will pick up the new session and show MainShell.
