...
import 'access_logs/access_logs_screen.dart';
...
class _MainShellState extends State<MainShell> {
  ...
  final List<Widget> _screens = const [
    ...
    CabinetsListScreen(),
    AccessLogsScreen(),
    Placeholder(label: 'Reports', icon: Icons.bar_chart_outlined),
    Placeholder(label: 'Notifications', icon: Icons.notifications_outlined),
    ProfileScreen()
  ];
